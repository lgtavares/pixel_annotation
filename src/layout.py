...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.homography = QtWidgets.QCheckBox('Homography')
        self.homography.setEnabled(False)
        self.homography.setChecked(False)

        grid_layout.addWidget(self.homography, 1, 0)

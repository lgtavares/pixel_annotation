...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.mark_checkbox    = QtWidgets.QCheckBox('Mark reference video')
        ...
        grid_layout.addWidget(self.contour_checkbox, 0, 0)
        grid_layout.addWidget(self.fill_checkbox, 0, 1)
        grid_layout.addWidget(self.mark_checkbox, 0, 2)

        offsetbox = QtWidgets.QHBoxLayout()
        self.ref_offset_sbox = QtWidgets.QSpinBox(self.centralwidget)
        self.ref_offset_sbox.setEnabled(False)
        self.ref_offset_sbox.setMinimum(-10)
        self.ref_offset_sbox.setMaximum(10)
        self.ref_offset_sbox.setValue(0)
        offsetbox.addWidget(QtWidgets.QLabel('Ref. Offset:'))
        offsetbox.addWidget(self.ref_offset_sbox)
        ...
        self.angle_checkbox   = QtWidgets.QCheckBox('Compensate inclination')
        self.angle_checkbox.setEnabled(False)
        self.homography_checkbox = QtWidgets.QCheckBox('Homography')
        self.homography_checkbox.setEnabled(False)
        self.homography_checkbox.setChecked(False)

        grid_layout.addWidget(self.homography_checkbox, 1, 0)
        grid_layout.addWidget(self.activate_checkbox, 1, 1)
        grid_layout.addWidget(self.angle_checkbox, 1, 2)
        grid_layout.addLayout(offsetbox, 2, 0)
        grid_layout.addWidget(self.load_pushbutton, 2, 1)
        grid_layout.addWidget(self.save_pushbutton, 2, 2)
        ...
        self.homography_checkbox.stateChanged.connect(self.set_morphology)
